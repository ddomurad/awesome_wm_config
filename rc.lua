...
-- Custom layout
local center_layout = require("center_layout")
...
mytextclock = wibox.widget.textclock('%F %T')

local markup = lain.util.markup
local separators = lain.util.separators

-- CAL
local w_cal = lain.widget.cal({
...
local w_mem = lain.widget.mem({
    settings = function()
        if mem_now.perc > 50 then
            widget:set_markup(markup.font(beautiful.font, markup("#ffa500", "[RAM:" .. mem_now.perc .. "%]")))
        elseif mem_now.perc > 75 then
            widget:set_markup(markup.font(beautiful.font, markup("#ff0000", "[RAM:" .. mem_now.perc .. "%]")))
        else
            widget:set_markup(markup.font(beautiful.font, markup("#00ff00", "[RAM:" .. mem_now.perc .. "%]")))
        end
    end
})
...
local w_cpu = lain.widget.cpu({
    settings = function()
        if cpu_now.usage > 25 then
            widget:set_markup(markup.font(beautiful.font, markup("#f6ff00", "[CPU:" .. cpu_now.usage .. "%]")))
        elseif cpu_now.usage > 50 then
            widget:set_markup(markup.font(beautiful.font, markup("#ffa500", "[CPU:" .. cpu_now.usage .. "%]")))
        elseif cpu_now.usage > 75 then
            widget:set_markup(markup.font(beautiful.font, markup("#ff0000", "[CPU:" .. cpu_now.usage .. "%]")))
        else
            widget:set_markup(markup.font(beautiful.font, markup("#00ff00", "[CPU:" .. cpu_now.usage .. "%]")))
        end
    end
})
    ...
    settings = function()
        if bat_now.status and bat_now.status ~= "N/A" then
            if bat_now.perc <= 10 then
                widget:set_markup(markup.font(beautiful.font, markup("#ff0000", "[BAT:" .. bat_now.perc .. "%]")))
            elseif bat_now.perc <= 25 then
                widget:set_markup(markup.font(beautiful.font, markup("#ffa500", "[BAT:" .. bat_now.perc .. "%]")))
            else
                widget:set_markup(markup.font(beautiful.font, markup("#00ff00", "[BAT:" .. bat_now.perc .. "%]")))
            end
        else
            widget:set_markup(markup.font(beautiful.font, markup("#00ff00", "[BAT: AC]")))
        end
    end
})
...
local w_volume = lain.widget.alsa({
    settings = function()
        ...
        elseif volume_now.level > 70 then
            widget:set_markup(markup.font(beautiful.font, markup("#ffa500", "[V:" .. volume_now.level .. "%]")))
...
local w_fs = lain.widget.fs({
    ...
    settings  = function()
        ...
        elseif fs_now["/"].percentage > 50 then
            ...
            widget:set_markup(markup.font(beautiful.font,
                markup("#00ff00", "[D:" .. string.format("%.2f", fs_now["/"].free) .. " " .. fs_now["/"].units .. "]")))
        end
    end
})
